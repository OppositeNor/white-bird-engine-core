...
TEST(CLAParser, BasicUtilityOnly) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "test_utility", .type = WBE::CLAToken::Type::UTILITY_NAME}};
...
TEST(CLAParser, LongOptionWithArgument) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "compiler", .type = WBE::CLAToken::Type::UTILITY_NAME},
...
TEST(CLAParser, ShortOptionWithArgument) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "logger", .type = WBE::CLAToken::Type::UTILITY_NAME},
...
TEST(CLAParser, MultipleOperationsAndOperands) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "gcc", .type = WBE::CLAToken::Type::UTILITY_NAME},
...
TEST(CLAParser, MixedRootOperandsAndOptions) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "processor", .type = WBE::CLAToken::Type::UTILITY_NAME},
...
TEST(CLAParser, ComplexRealWorldExample) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "g++", .type = WBE::CLAToken::Type::UTILITY_NAME},
        {.value = "main.cpp", .type = WBE::CLAToken::Type::OPERAND},
...
TEST(CLAParser, ConsecutiveOptions) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "utility", .type = WBE::CLAToken::Type::UTILITY_NAME},
        {.value = "--verbose", .type = WBE::CLAToken::Type::OPTION_LONG},
        {.value = "--debug", .type = WBE::CLAToken::Type::OPTION_LONG},
...
TEST(CLAParser, ErrorInvalidFirstToken) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "--invalid", .type = WBE::CLAToken::Type::OPTION_LONG}};
...
TEST(CLAParser, OptionsWithNoArgumentsFollowedByMoreOptions) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "test", .type = WBE::CLAToken::Type::UTILITY_NAME},
        {.value = "-v", .type = WBE::CLAToken::Type::OPTION_SHORT},
        {.value = "--debug", .type = WBE::CLAToken::Type::OPTION_LONG},
        {.value = "--output", .type = WBE::CLAToken::Type::OPTION_LONG},
...
TEST(CLAParser, SingleRootOperandOnly) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "cat", .type = WBE::CLAToken::Type::UTILITY_NAME},
        {.value = "file.txt", .type = WBE::CLAToken::Type::OPERAND}};
...
TEST(CLAParser, MultipleRootOperands) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "concat", .type = WBE::CLAToken::Type::UTILITY_NAME},
        {.value = "file1.txt", .type = WBE::CLAToken::Type::OPERAND},
        {.value = "file2.txt", .type = WBE::CLAToken::Type::OPERAND},
...
TEST(CLAParser, MultipleShortOptionsInOnePrefix) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "tool", .type = WBE::CLAToken::Type::UTILITY_NAME},
...
TEST(CLAParser, MultipleShortOptionsWithOperands) {
    ...
    std::vector<WBE::CLAToken> tokens = {{.value = "ls", .type = WBE::CLAToken::Type::UTILITY_NAME},
