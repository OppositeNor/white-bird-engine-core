...
*/
#ifndef WBE_FILE_CLA_AST_VISITOR_ASSEMBLER_TEST_HH
#define WBE_FILE_CLA_AST_VISITOR_ASSEMBLER_TEST_HH
...
TEST(CLAASTVisitorAssembler, OperationWithInsufficientArguments) {
    ...
    ASSERT_THROW({ root->accept(&assembler); }, std::runtime_error);
}
