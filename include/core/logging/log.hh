...
// default labels
WBE_DEFINE_LABEL(WBE_CHANNEL_UNKNOWN, WBE_CHANNEL)
WBE_DEFINE_LABEL(WBE_CHANNEL_GLOBAL, WBE_CHANNEL)
WBE_DEFINE_LABEL(WBE_CHANNEL_USER, WBE_CHANNEL)
WBE_DEFINE_LABEL(WBE_CHANNEL_DEBUG, WBE_CHANNEL)
