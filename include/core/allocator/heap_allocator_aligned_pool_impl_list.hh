...
public:
    HeapAllocatorAlignedPoolImplicitList() : HeapAllocatorAlignedPoolImplicitList(WBE_KI_B(64)) {
    }
     ...
     */
    HeapAllocatorAlignedPoolImplicitList(MemoryChunk p_memory_chunk, size_t p_start_offset, size_t p_size);
